...
3. Go backend sends two emails via SMTP relay (from `web-inquiry@gathercateringandevents.com`):
...
| `js/form.js` | Inquiry form validation, service checkbox generation, submission to Go API |
